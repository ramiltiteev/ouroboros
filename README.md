...
Telegram --> colab_launcher.py
            ...
            ouroboros/               (agent core)
              ...
              llm.py                -- LLM client (Cloud.ru/OpenAI-compatible API)
...
|-----|----------|-----------------|
| `CLOUDRU_API_KEY` | Yes | Cloud.ru Foundation Models API key |
...
CFG = {
    ...
    # Models
    "OUROBOROS_MODEL": "anthropic/claude-sonnet-4.6",            # primary LLM
    ...
    "OUROBOROS_LLM_BASE_URL": "https://foundation-models.api.cloud.ru/v1",
...
|----------|-------------|
| `CLOUDRU_API_KEY` | Cloud.ru Foundation Models API key for LLM calls |
...
| `OUROBOROS_LLM_BASE_URL` | `https://foundation-models.api.cloud.ru/v1` | Base URL for OpenAI-compatible LLM endpoint |
| `OUROBOROS_LLM_API_KEY` | *(unset)* | Explicit API key override for the LLM endpoint |
